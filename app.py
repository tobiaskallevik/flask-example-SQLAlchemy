...
# Loads the correct configuration based on the environment
if os.getenv('FLASK_ENV') == 'development':
    ...
    raise Exception('FLASK_ENV is not set or is set to an invalid value.')

# Import database functions after app is created to avoid circular imports
